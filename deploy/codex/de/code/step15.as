!   Einkaufsliste 3
    ...
    erstelle Gefiltert
    setze den stil von Gefiltert zu `margin:1em`
    setze den text von Gefiltert zu `Gefiltert`
    bei klick Gefiltert
    beginn
        lege OriginalListe in AnzeigeListe
        filtere AnzeigeListe mit PreisFilter
        sortiere AnzeigeListe mit PreisSort
        gosub zu Anzeige
    ende
...
PreisFilter:
    ...
    wenn eigenschaft `price` von A ist nicht kleiner als 100 setze Ergebnis
    sonst leere Ergebnis
