...
Construisez un jeu de Morpion. Une fois votre système en place (voir l'onglet *Démarrer*), soumettez ces prompts un à un à votre agent IA. Les quatre étapes — Fondations, Mécanique, Analyse, Stratégie — reviennent dans de nombreux projets ; ce schéma vaut la peine d'être appris.

## Prompt 1 : Fondations — Construire le plateau
...
## Prompt 2 : Mécanique — Ajouter le tour par tour
...
## Prompt 3 : Analyse — Détecter un vainqueur
...
## Prompt 4 : Stratégie — Tenter de gagner
