...
Costruisci un gioco di TicTacToe. Una volta configurato il sistema (vedi la scheda Inizio), invia questi prompt uno alla volta al tuo agente AI.

## Prompt 1: Costruisci il tabellone
...
## Prompt 2: Aggiungi il gioco a turni
...
## Prompt 4: Migliora la strategia del computer
