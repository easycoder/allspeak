...
from .as_dbg_value_display import ValueDisplay
from .as_dbg_watchlist import WatchListWidget
...
class Debugger(QMainWindow):
    ...
    def __init__(self, program, width=800, height=600, ratio=0.2):
        ...
        self.setWindowTitle("AllSpeak Debugger")
    ...
    def _saveQueueState(self):
        ...
        try:
            ...
            self.saved_queue = list(as_program.queue)
        except Exception as ex:
    ...
    def _restoreQueueState(self):
        ...
        try:
            ...
            if self.saved_queue:
                as_program.queue.clear()
                as_program.queue.extend(self.saved_queue)
        except Exception as ex:
