...
Because AllSpeak only supports integer arithmetic, multiply the candidate and each of the existing primes by 10 before calling the modulo function.

Use the AllSpeak built-in array mechanism. You could alternatively use a 'list' type for the Primes variable, and index this explicitly at each step.
