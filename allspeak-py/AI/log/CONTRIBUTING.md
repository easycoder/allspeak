# Contributing to AllSpeak-py

Thank you for your interest in contributing to AllSpeak-py! This guide will help you get started with the development workflow, including how to work with Git branches and merge changes.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR-USERNAME/allspeak-py.git
   cd allspeak-py
   ```
3. **Add upstream remote** to keep your fork synchronized:
   ```bash
   git remote add upstream https://github.com/allspeak/allspeak-py.git
   ```
4. **Install dependencies** (in development mode, allowing you to modify code without reinstalling):
   ...
   This will install all required dependencies from `pyproject.toml` and make the `allspeak` command available.
...
2. **Go to GitHub** and create a Pull Request from your branch to `allspeak:main`
...
By contributing to AllSpeak-py, you agree that your contributions will be licensed under the same license as the project.

---

Thank you for contributing to AllSpeak-py! Your efforts help make this project better for everyone.
