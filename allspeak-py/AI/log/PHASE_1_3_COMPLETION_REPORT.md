...
- `as_compiler.py` — Added skipArticles()
- `as_handler.py` — Exposed skipArticles to handlers
- `as_graphics.py` — Updated k_set, k_remove with skipArticles + comments
- `as_value.py` — Added "the cat of" value parsing
- `as_core.py` — Updated fork/go/gosub to use skip('to')
...
allspeak-py/
  allspeak/
    as_compiler.py          ✅ Updated (skipArticles)
    as_handler.py           ✅ Updated (expose skipArticles)
    as_graphics.py          ✅ Updated (k_set, k_remove)
    as_value.py             ✅ Updated (cat pattern)
    as_core.py              ✅ Updated (fork/go/gosub)
