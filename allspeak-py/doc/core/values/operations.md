...
This document inventories all **value-level operations** in the AllSpeak core module. These are operations that evaluate to a value (rather than executing as commands) and appear in expressions, assignments, and conditions.
